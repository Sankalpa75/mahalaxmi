<?php 
$to = " purnathapa2013@gmail.com";
$subject = "New Quote Information from website |   Mahalaxmi Printing Press ";
$headers = "From: " . strip_tags($_POST['txt_fname'])." <".strip_tags($_POST['txt_phone'])."> \r\n";
